package bcntec.training.springboot.microservices.docker.pss.search.apigateway;
...
public class SearchApiGateway {
    ...
    @Bean
    public bcntec.training.springboot.microservices.docker.pss.search.apigateway.CustomZuulFilter customFilter() {
