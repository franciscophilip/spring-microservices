package  bcntec.training.springboot.microservices.config.search.component;

import  bcntec.training.springboot.microservices.config.search.controller.SearchQuery;
import  bcntec.training.springboot.microservices.config.search.entity.Flight;
import  bcntec.training.springboot.microservices.config.search.entity.Inventory;
import  bcntec.training.springboot.microservices.config.search.repository.FlightRepository;
